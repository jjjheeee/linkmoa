"""
Django settings for linkmoa project.
...
SECRET_KEY = "django-insecure-d&1z@j59vl)vm*j@cvpqc*b_a%z5z*#e$h$x&-p%ur6+yrsx*o"
...
if ENVIRONMENT == "production":
    ...
    DATABASES = {
        "default": {
            "ENGINE": "django.db.backends.sqlite3",
            "NAME": BASE_DIR / "db.sqlite3",  # 개발 환경용 SQLite 파일
        }
    }
